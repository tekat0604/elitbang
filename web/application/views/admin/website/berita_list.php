...
$(document).ready(function(){
    function berita_list() {
        $('#berita_list').dataTable({
            ...
            autoWidth: false,
            ajax: "<?=base_url()?>admin/website/berita/get_berita",
            ...
            columns: [
                    ...
                    {'data': (d)=>{
                            ...
                            btn += '<a href="<?=base_url()?>admin/website/berita/berita_edit/'+d.id_berita+'" class="btn btn-sm btn-secondary btn-square min-width-125 show_modal_edit"><span class="fa fa-pencil"></span> Edit </a><br>';
...
$(".berita_baru").click(function() {
    window.location.replace('<?= base_url('admin/website/berita/berita_baru');?>');
});
...
function berita_hapus(t,id){
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
            url: '<?=base_url()?>admin/website/berita/berita_hapus',
            type: 'POST',
            dataType: 'JSON',
            data: {id:id},
