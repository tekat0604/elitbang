		...
		<div class="modal-content">
			<div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title model_title">Tambah Kategori Bencana</h3>
					...
					<div class="p-20">
						<div class="row">
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="nama_kategori_bencana" id="tambah_nama_kategori_bencana" 
								maxlength="100" class="form-control" placeholder="Nama Kategori"/> 
								 <span id="error_tambah_nama_kategori_bencana" class="validasi"></span> 
							</div>
						</div>  
