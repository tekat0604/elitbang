...
$(document).ready(function(){
    ...
    $('#pilih_koordinat').select2({
        ajax: {
            url: '<?=base_url()?>admin/peta_intip/ref_koordinat',
            dataType: 'JSON',
            data: function(d){
                let q = {
                    search: d.term,
...
$('#tambah_data_peta').submit(function(e){
    ...
    else
    {
        ...
        $.ajax({
            url:'<?php echo base_url();?>admin/peta_intip/simpan_data_peta_edit',
            type:"post",
            data: form_data,
            processData:false,
            contentType:false,
            ...
            success: function(response){
                ...
                window.location.replace("<?= base_url('admin/peta_intip/data_peta/').$this->uri->segment(4);?>");
