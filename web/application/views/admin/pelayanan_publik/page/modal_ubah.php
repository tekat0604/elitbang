						...
						<div class="p-20">
							<div class="row">
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" name="judul" id="ubah_judul" maxlength="100" class="form-control" placeholder="Judul" />
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<textarea name="konten" id="ubah_konten" rows="10" class="form-control" placeholder="Masukkan Konten"></textarea>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-12">
									<label for="nama">Link</label>
									<textarea name="link" id="ubah_link" class="form-control" placeholder="www.link.com"></textarea>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-12">
									<div class="custom-file">
										<input type="file" class="custom-file-input" id="ubah_image" name="image" accept="image/*">
