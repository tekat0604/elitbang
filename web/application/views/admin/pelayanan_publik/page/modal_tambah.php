			...
			<div class="modal-content">
				<div class="block block-themed block-transparent mb-0">
					<div class="block-header bg-primary-dark">
						<h3 class="block-title model_title">Tambah Pelayanan Publik</h3>
						...
						<div class="p-20">
							...
							<div class="row">
								<div class="form-group col-md-12">
									...
									<textarea name="konten" id="tambah_konten" rows="10" class="form-control" placeholder="Masukkan Konten"></textarea>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-12">
									<label for="nama">Link</label>
									<textarea name="link" id="tambah_link" class="form-control" placeholder="www.link.com"></textarea>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-12">
									<label for="nama">Upload <i class="text-danger" style="margin-left: 110px; font-weight: normal;">Ukuran Terbaik 1679 x 790 px</i> </label>
