		...
		<div class="modal-content">
			<div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title model_title">Ubah Agenda Kegiatan</h3>
					...
					<div class="p-20">
						<div class="row">
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="nama_kegiatan" id="ubah_nama_kegiatan" 
								maxlength="200" class="form-control" placeholder="Nama Kegiatan"/> 
								 <span id="error_ubah_nama_kegiatan" class="validasi"></span> 
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-12">
								<label for="nama">Tempat Kegiatan</label> 
								<input type="text" class="form-control" name="tempat_kegiatan" id="ubah_tempat_kegiatan"  
								placeholder="Masukkan Tempat Kegiatan"/> 
								 <span id="error_ubah_tempat_kegiatan" class="validasi"></span> 
							</div>
						</div> 
						<div class="row">
							<div class="form-group col-md-12">
								<label for="nama">Tanggal Kegiatan</label> 
								<input type="text" class="date_picker form-control" id="ubah_tanggal_kegiatan" name="tanggal_kegiatan" 
