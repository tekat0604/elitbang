		...
		<div class="modal-content">
			<div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title model_title">Ubah Grid 2</h3>
					...
					<div class="p-20">
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<div id="ubah_image_preview_container" class="form-group" style="width: 120px; height: auto; overflow:hidden;line-height: auto;border:1px solid #dddddd; background-color:#ffffff"> 
								</div>
