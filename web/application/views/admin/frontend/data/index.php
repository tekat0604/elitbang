    ...
    <div class="content">
        ...
        <div class="block block-themed">
            <div class="block-header bg-gd-sun">
                <h3 class="block-title">Data Informasi</h3>
                <button type="button" class="btn btn-secondary btn-square" style="margin-bottom:10px;" data-toggle="modal" data-target="#modal-data"><i class="fa fa-plus"></i> Tambah Informasi</button>
            </div>
...
<div class="modal fade" id="modal-data" tabindex="-1" role="dialog" aria-labelledby="modal-popin" aria-hidden="true">
            ...
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="block-content">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input required type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan nama sistem">
                        </div>
                    </div>
                    <div class="form-group row">
