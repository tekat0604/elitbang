...
<head>
    ...
    <title>Sistem Informasi BPDB Kota Surakarta</title>
...
<body>
    <div id="page-container" class="page-header-fixed page-header-glass padding_10px">
        <?php
        if ($get_profil_website->image != '' && $get_profil_website->image != null) {
            $img_logo_desktop   = '<img src="' . base_url('uploads/logo/' . $get_profil_website->image . '') . '" alt="" style="width: 150px;">';
            $img_logo_mobile    = '<img src="' . base_url('uploads/logo/' . $get_profil_website->image . '') . '" alt="" style="width: 150px;">';
        } else {
            $img_logo_desktop   = '<img src="' . base_url('assets/solo.png') . '" alt="">';
            $img_logo_mobile    = '<img src="' . base_url('assets/solo.png') . '" alt="">';
        }
        ?>
        <div id="page-header">
            <div class="content-header">
                ...
                <div class="content-header-section">
                    ...
                    <button id="btn_map_menu" type="button" class="btn btn-lg mr-10 ml-30" title="Tampil atau sembunyikan menu">
        ...
        <div id="mobile_header" style="display:none;">
            <div class="row" style="margin-right:0px; padding: 10px;">
                <div class="col-12">
                    <div style="float: left; width: 185px;">
                        <?php echo $img_logo_mobile; ?>
                    </div>
                    <div style="float: left; width: 110px; ">
                        <div style="margin-bottom: 5px;">
                            <a href="<?php echo base_url('peta'); ?>" class="btn btn-sm btn-secondary" style="width: 100px;">
                                <i class="fa fa-refresh"></i> Reload </a>
                        </div>
                        <div>
                            <a href="<?php echo base_url(); ?>" style="color: #ff9900; font-size: 13px;">
                    ...
                    <div class="layer_group_content pl-10">
                        ...
                        <?php foreach ($list_layer as $jpk => $jpv) : ?>
                            ...
                            <?php foreach ($jpv['data'] as $glk => $glv) : ?>
                                ...
                                <div style="font-size: normal; margin-left:10px" data-toggle="collapse" data-target="#gl_<?= $jpk . '_' . $glk ?>" data-id="<?= $jpk . '_' . $glk ?>" data-device="large-screen">
                                    <i class="si si-pointer"></i> <?= $glv['src']['nama_grup_layer'] ?>
                                    <span id="cl_<?= $jpk . '_' . $glk ?>" class="count_layer badge badge-pill badge-info"><?= count($glv['data']) ?></span>
                                </div>
                                        ...
                                        <div style="margin-left:30px;">
                                            ...
                                            <span class="bar_loader" data-name="<?= $lv['slug'] ?>">
                                                <svg width="25px" height="25px" xmlns="http://www.w3.org/2000/svg" viewBox="0 -25 100 100" preserveAspectRatio="xMidYMid" class="lds-facebook">
                                                    <rect ng-attr-x="{{config.x1}}" ng-attr-y="{{config.y}}" ng-attr-width="{{config.width}}" ng-attr-height="{{config.height}}" ng-attr-fill="{{config.c1}}" x="17.5" y="30" width="15" height="40" fill="#ff0000">
            ...
            <div class="block-content tab-content overflow-hidden">
                        ...
                        <div class="layer_group">
                            ...
                            <div class="layer_group_content pl-10">
                                <?php foreach ($list_layer as $jpk => $jpv) : ?>
                                    ...
                                    <?php foreach ($jpv['data'] as $glk => $glv) : ?>
                                        <div style="font-size: normal; margin-left:10px" data-toggle="collapse" data-target="#mgl_<?= $jpk . '_' . $glk ?>" data-id="<?= $jpk . '_' . $glk ?>" data-device="mobile"><i class="si si-pointer"></i> <?= $glv['src']['nama_grup_layer'] ?> <span id="mcl_<?= $jpk . '_' . $glk ?>" class="count_layer badge badge-pill badge-info"><?= count($glv['data']) ?></span></div>
                ...
                <div class="tab-pane fade" id="mobile_latlng" role="tabpanel">
                    ...
                    <div class="mt-20 mb-20">
                        <button id="m_cari_latlng" class="btn btn-map col-12 btn_search_latlng"><i class="si si-magnifier"></i> Cari</button>
                    </div>
                </div>
    ...
    <div id="myfooter">
        <div class="row">
            ...
            <div class="col-lg-1 col-sm-12">
                <button id="cari_latlng" class="btn btn-map btn_search_latlng"><i class="si si-magnifier"></i> Cari</button>
            </div>
        </div>
    ...
    <div class="modal" id="modal_infografis" tabindex="-1" role="dialog" aria-labelledby="modal-large" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-popin" role="document">
            <div class="modal-content" style="border-radius: 20px; border: 3px solid rgba(3, 65, 122, 0.5);">
