...
<body id="top" class="has-header-search">
    ...
    <section class="rev_slider_wrapper">
        <div class="rev_slider materialize-slider">
            <ul>
                <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="assets/img/slider1.jpg" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="materialize Material" data-description="">
                     <video class="hidden-xs" controls autoplay loop muted id="myVideo" width="100%">
						<source src="<?= base_url();?>assets/video/surakarta2.mp4" type="video/mp4">
					 </video>
					<div class="tp-overlay"></div>
                    <div class="tp-caption tp-resizeme" data-x="center" data-y="center" data-voffset="-50" data-transform_idle="o:1;" data-transform_in="x:-50px;opacity:0;s:600;e:Power2.easeOut;" data-transform_out="opacity:0;s:1500;e:Power4.easeIn;s:1500;e:Power4.easeIn;" data-start="2000" style="z-index: 5;">
                        <div><img class="img-responsive" src="<?=base_url()?>assets/front/img/logo-intip3.png" alt="" data-lazyload="<?=base_url()?>assets/front/img/logo-intip3.png">
                        </div>
                    </div>
    ...
    <section class="padding-top-110 padding-bottom-110">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2 class="font-30 mb-30">Selamat Datang di Intip Kota Surakarta</h2>
                    <p>INTIP Solo merupakan sistem informasi yang menyajikan peta digital berbasis WebGIS. Sistem informasi ini menampilkan data geospasial Infrastruktur, Tata Ruang dan Perencanaan Kota Solo beserta dengan metadatanya. </p>
                    <p> INTIP Solo merupakan sarana berbagi data (data sharing) dan publikasi data geospasial. Data geospasial sebagai One Map Policy di Kota Surakarta dapat berperan dalam perumusan kebijakan.</p>
                    </p>
                </div>
                <div class="padding-top-30 col-md-6">
                    <img style="margin-right: auto; margin-left: auto; display: block;" src="<?=base_url()?>assets/front/img/solo-3d.png" class="img-responsive " alt="Image">
                </div>
            </div>
        </div>
    </section>
    <!-- <section class="section-padding gray-bg">
        <div class="container">
            <div class="text-center mb-80">
                <h2 class="section-title text-uppercase">Data Intip</h2>
                <p class="section-sub">Quisque non erat mi. Etiam congue et augue sed tempus. Aenean sed ipsum luctus, scelerisque ipsum nec, iaculis justo. Sed at vestibulum purus, sit amet viverra diam. Nulla ac nisi rhoncus,</p>
            </div>
            <div class="row equal-height-row">
                <div class="col-md-3 mb-30">
                    <a href="informasi-geospasial.html" target="_blank">
                        <div class="featured-item border-box radius-4 hover brand-hover equal-height-column">
                            <div class="icon mb-30">
                                <i class="material-icons brand-icon red-text text-accent-4">&#xE32A;</i>
                            </div>
                            <div class="desc">
                                <h2>Geospasial</h2>
                ...
                <div class="col-md-3 mb-30">
                    <a href="album-peta.html" target="_blank">
                        <div class="featured-item border-box radius-4 hover brand-hover equal-height-column">
                            <div class="icon mb-30">
                                <i class="material-icons brand-icon red-text text-accent-4">&#xE0BF;</i>
                            </div>
                ...
                <div class="col-md-3 mb-30">
                    <a href="publikasi.html" target="_blank">
                        <div class="featured-item border-box radius-4 hover brand-hover equal-height-column">
                            <div class="icon mb-30">
                                <i class="material-icons brand-icon red-text text-accent-4">&#xE323;</i>
                            </div>
                ...
                <div class="col-md-3 mb-30">
                    <a href="statistik.html" target="_blank">
                        <div class="featured-item border-box radius-4 hover brand-hover equal-height-column">
                            <div class="icon mb-30">
                                <i class="material-icons brand-icon red-text text-accent-4">&#xE32A;</i>
                            </div>
    ...
    <section class="parallax-bg banner-5 bg-fixed overlay dark-5 padding-top-100" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="mb-80 text-center">
                <h2 class="font-30 white-text text-extrabold text-uppercase">Peta Informasi Tata Ruang Infrastruktur Dan Perencanaan</h2>
                ...
                <a href="#" class="btn btn-lg waves-effect waves-light text-medium red accent-4">Selengkapnya</a> -->
            </div>
        </div>
        <div class="mocup-wrapper text-center">
            <img src="<?=base_url()?>assets/front/img/map.png" alt="image">
        </div>
    </section>
