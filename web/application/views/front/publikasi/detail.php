...
<body id="top" class="has-header-search">
    ...
    <section style="height:500px;width:100%;background: url('<?=base_url()?>/assets/img/uploads/berita/<?=@$publikasi["thumbnail_url"]?>') no-repeat; background-size: cover;">
    <div  style="height:500px;width:100%;background:#00000093;"></div>
    </section>
    <section class="section-padding">
        <div class="container">
            <div class="text-center mb-50">
                <h2 class="section-title"><?=@$publikasi['judul']?></h2>
                <p class="section-sub">
                    <span><i class="fa fa-calendar"></i> <?=@$publikasi['added']?></span> | 
                    <span><i class="fa fa-pencil"></i> <?=@$publikasi['nama']?></span>
                </p>
            </div>
            <div><?=@$publikasi['isi']?></div>
        </div>
    </section>
