                    ...
                    <div class="col-xl-6">
                        <form method="post" id="tambah_data_peta">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input name="stroke_opacity" type="number" min="0" max="1" value="1" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input name="fill_opacity" type="number" min="0" max="1" value="1" class="form-control">
                                </div>
                            </div>

                            <!-- Input Map Feature Styles | Line / LineString -->
                            <?php elseif($this->uri->segment(5) == 'line'):?>
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="stroke">Stroke <span class="text-danger">*</span></label>
                                <div class="col-lg-8">
                                    <div class="js-colorpicker input-group">
