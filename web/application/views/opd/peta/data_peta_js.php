            ...
            success : function(data){
                ...
                for(i=0; i<data['data'].length; i++){
                    ...
                    html += '<td style="text-align: center;">'+
                                '<a href="<?= base_url();?>opd/peta/edit_data_peta/'+data['data'][i].id_layer+'/'+data['data'][i].tipe_layer+'/'+data['data'][i].id_collection+'" class="btn btn-sm btn-warning mb-10" data="'+data['data'][i].id_layer+'" title="Edit Data"><i class="fa fa-pencil"></i></a> '+
                                ' '+
                                ...
                                ' '+
                                '<a href="<?= base_url();?>opd/peta/diskripsi/<?= $id;?>/'+data['data'][i].id_collection+'" class="btn btn-sm btn-success mb-10" data="'+data['data'][i].id_layer+'" title="Deskripsi Halaman Detail"><i class="fa fa-file"></i></a> '+
                                ' '+
