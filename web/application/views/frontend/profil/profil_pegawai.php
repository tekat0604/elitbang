    ...
    <div class="container">
        <div class="col-lg-12">
            ...
            <ul class="breadcrumb pull-right">
                <li>
                    <a href="<?php echo base_url('./'); ?>"> Profil Pegawai </a>
                </li>
                <li>Detail</li>
            </ul>
        </div>
                ...
                if (count($data) > 0) {
                    foreach ($data as $key => $value) {
                        ...
                        if ($value->link != '' && $value->link != null) {
                            $link_pegawai = ' <a href="http://' . $value->link . '" target="_blank" class="btn btn-warning btn-md">  Lihat <i class="fa fa-arrow-right"></i> </a>';
                        } else {
                            $link_pegawai = '';
                        }
                ?>
