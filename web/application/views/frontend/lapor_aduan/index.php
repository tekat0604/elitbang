            ...
            <div class="col-md-12">
                <form id="form_pengiriman_aduan" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" style='margin-bottom: 0px;'>
                                ...
                                <input type="text" id="latitude" name="latitude" value="<?= @set_value('latitude') ?>" class="form-control" placeholder="Latitutude" readonly="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group" style='margin-bottom: 0px;'>
                                <label for="label" class="text_dongker"> Longitude</label>
                                <input type="text" id="longitude" name="longitude" value="<?= @set_value('longitude') ?>" class="form-control" placeholder="Longitude" readonly="">
                            </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="label" class="text_dongker">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="label" class="text_dongker"> Kategori Bencana <span class="text-danger">*</span> </label>
                                <select class="form-control" id="id_kategori" name="id_kategori" placeholder="Kategori Bencana">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="label" class="text_dongker"> Subjek <span class="text-danger">*</span> </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="label" class="text_dongker"> Kecamatan </label>
                                <select class="form-control" id="id_kecamatan" name="id_kecamatan" placeholder="Kecamatan" onchange="getKelurahan(this);">
                                    <option value="">Pilih Kelurahan </option>
                                    <?php foreach (@$kecamatan as $row) { ?>
                                        <option value="<?= @$row->id_kecamatan ?>"><?= @$row->nama ?></option>
                                    <?php } ?>
                                </select>
                                <div id='error_id_kecamatan' class="validasi"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="label" class="text_dongker"> Kelurahan </label>
                                <select class="form-control" id="id_kelurahan" name="id_kelurahan" placeholder="kelurahan">
                                    <option value="">Pilih Kelurahan </option>
                                </select>
                                <div id='error_id_kelurahan' class="validasi"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="label" class="text_dongker"> Detail Lokasi <span class="text-danger">*</span> </label>
                                <textarea class="form-control" name="detail_lokasi" id="detail_lokasi" rows="5" placeholder="detail_lokasi *)"></textarea>
                            </div>
                        </div>
                    </div>
