...
class Table_form3 extends CI_Model
{
    var $column_order   = array(null,  'b.nomor_identitas', 'c.jenis_kejadian', 'c.nomor_kejadian'); //field yang ada di table user
    var $column_search  = array('b.nomor_identitas', 'c.jenis_kejadian', 'c.nomor_kejadian'); //field yang diizin untuk pencarian
    ...
    {
        $this->db->select('a.id,  
        b.jenis_identitas, b.nomor_identitas, b.nama_pelapor, 
        c.jenis_kejadian, c.nomor_kejadian, 
        d.nama kecamatan, e.nama kelurahan, c.alamat_kejadian, 
        c.tanggal_kejadian, c.hari_kejadian, c.jam_kejadian,
        c.jam_laporan, c.kronologi_kejadian');
        $this->db->from('kejadian_bencana a');
        $this->db->join('kejadian_bencana b', 'a.id_form_1 = b.id AND b.jenis_form="form_a1" ', 'LEFT');
        $this->db->join('kejadian_bencana c', 'a.id_form_2 = c.id AND c.jenis_form="form_a2" ', 'LEFT');
        $this->db->join('tabel_kecamatan d', 'c.id_kecamatan_kejadian = d.id_kecamatan', 'LEFT');
        $this->db->join('tabel_kelurahan e', 'c.id_kelurahan_kejadian = e.id_kelurahan', 'LEFT');


        $this->db->where('a.jenis_form="form_a3"');
    ...
    function generate_table()
    {
        ...
        foreach ($list as $field) {
            ...
            $btn = ' 
            <a href="' . base_url('admin/kejadian_bencana/form3/edit/' . $field->id) . '" class="btn btn-secondary" style="width: 100px; margin-bottom: 5px;">
