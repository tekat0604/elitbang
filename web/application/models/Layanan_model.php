...
class Layanan_model extends CI_Model {
	var $table = 'tabel_layanan'; //nama tabel dari database
    var $column_order = array(null, 'nama_layanan'); //field yang ada di table user
    var $column_search = array('nama_dokumen'); //field yang diizin untuk pencarian 
