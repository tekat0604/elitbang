...
class Regulasi_model extends CI_Model {
	var $table = 'tabel_regulasi'; //nama tabel dari database
    var $column_order = array(null, 'nama_dokumen', 'tanggal_disahkan'); //field yang ada di table user
    var $column_search = array('nama_dokumen', 'tanggal_disahkan'); //field yang diizin untuk pencarian 
