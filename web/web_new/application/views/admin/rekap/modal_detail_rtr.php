...
<h3><?php echo $hasil['nama'] ?> <small class="text-red"><b>(<?php echo $hasil['nama_kelurahan'].', '.$hasil['nama_kecamatan'] ?>)</b></small></h3>
<hr>
    ...
    <div class="col-md-12">  
        <div class="js-wizard-simple block"> 
            <ul class="nav nav-tabs nav-tabs-alt nav-fill" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="#wizard-simple2-step1" data-toggle="tab">1. Detail</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#wizard-simple2-step2" data-toggle="tab">2. Foto</a>
                </li> 
            </ul>
            <div class="block-content block-content-full tab-content" style="min-height: 267px;">
				...
				<div class="tab-pane" id="wizard-simple2-step2" role="tabpanel">
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label" for="file_denah_lokasi">Denah lokasi yang dimintakan rekomendasi</label>
                        <div class="col-lg-8">
                            <img src="<?= base_url($data_perijinan->url_denah_lokasi);?>" style="width: 500px;">
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
