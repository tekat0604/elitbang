		...
		<div class="modal-content">
			<div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title model_title">Ubah Berita</h3>
					...
					<div class="p-20">
						<div class="row">
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="kapasitas" id="ubah_kapasitas" 
								class="form-control" placeholder="Kapasitas"/> 
								 <span id="error_ubah_kapasitas" class="validasi"></span> 
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-12">
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="keterangan" id="ubah_keterangan" 
