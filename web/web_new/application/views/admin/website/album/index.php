    ...
    <div class="content"> 
        ...
        <div class="block block-themed">
            <div class="block-header bg-primary-dark">
                <h3 class="block-title">Data Album Per-Kategori</h3>
            ...
            <div class="block-content" id="tampil_album_kategori">
                ...
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <div class="block-content">
                        ...
                        <div class="form-group row">
                            <label class="col-12" for="id_album_kategori">Album Kategori</label>
                            <div class="col-md-12">
                                <select class="form-control select2" id="id_album_kategori" name="id_album_kategori">
