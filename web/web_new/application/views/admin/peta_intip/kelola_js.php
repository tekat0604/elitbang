...
function isian() {
    ...
    $.ajax({
        type : "GET",
        url  : "<?php echo base_url('admin/peta_intip/get_layer_data')?>",
        dataType : "JSON",
        data : {id:id},
...
$('#form_layer').submit(function(e){
    e.preventDefault();
    $.ajax({
        url:'<?php echo base_url();?>admin/peta_intip/ubah_layer',
        type:"post",
...
$('#form_atribut').submit(function(e){
    e.preventDefault();
    $.ajax({
        url:'<?php echo base_url();?>admin/peta_intip/simpan_atribut',
        type:"post",
        data:new FormData(this),
        processData:false,
        contentType:false,
...
function daftar_atribut(){
    ...
    $.ajax({
        type  : 'ajax',
        url   : '<?php echo base_url()?>admin/peta_intip/daftar_atribut?id='+<?= $this->uri->segment(4);?>,
        async : false,
        dataType : 'json',
        success : function(data){
            var html = '';
...
$('#show_data').on('click','.item_edit',function(){
    ...
    $.ajax({
        type : "GET",
        url  : "<?php echo base_url('admin/peta_intip/get_atribut')?>",
        dataType : "JSON",
        data : {id:id},
        success: function(data){
...
$('.btn-ubah-atribut').on('click',function(){
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo base_url('admin/peta_intip/ubah_atribut')?>",
        dataType : "JSON",
...
function hapus(id){
    $.ajax({
    type : "POST",
    url  : "<?php echo base_url('admin/peta_intip/hapus_atribut')?>",
    dataType : "JSON",
