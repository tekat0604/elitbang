    ...
    <div class="content">
        ...
        <?php }else{ ?>
            <div class="alert alert-danger" role="alert">
                ...
                <hr>
                    <button type="button" class="btn btn-square btn-danger" onclick="window.location.href='<?= base_url('admin/peta/kelola/').$this->uri->segment(4); ?>'"><i class="fa fa-plus"></i> Buat atribut</button>
            </div>
        <?php } ?>
    </div>
</main>
