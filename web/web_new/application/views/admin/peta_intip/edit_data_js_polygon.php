...
function init_map()
{
    ...
    var geojson_url = '<?=base_url()?>admin/peta_intip/edit_data_peta_geojson/<?=$this->uri->segment(6)?>';
    ...
    $('#pilih_koordinat').change(function(){
        ...
        {
            $.ajax({
                url: '<?php echo base_url();?>admin/peta_intip/get_koordinat',
                type: 'GET',
                dataType: 'JSON',
                data: {id: val, type: 'Polygon'}
            })
            .then(res=>{
                let x = [{
...
<?php require_once('edit_data_js.php'); ?>