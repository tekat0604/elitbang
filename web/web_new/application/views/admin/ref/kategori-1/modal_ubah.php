		...
		<div class="modal-content">
			<div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title model_title">Ubah Kategori Berita</h3>
					...
					<div class="p-20">
						<div class="row">
							<div class="form-group col-md-12">
								...
								<input type="text" class="form-control" name="nama_kategori_menu" id="ubah_nama_kategori_menu" 
								maxlength="100" class="form-control" placeholder="Nama Kategori"/> 
								 <span id="error_ubah_nama_kategori_menu" class="validasi"></span> 
							</div>
						</div> 
