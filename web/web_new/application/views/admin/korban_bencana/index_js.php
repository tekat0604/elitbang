<script type="text/javascript" language="javascript">
	$(document).ready(function() {
				...
				columns: [{
					...
					<div class="d-flex align-items-center">
						...
						<div style="width: 150px!important; float: left; background: #fff;">
							<h6 class="mb-0">Nama : ` + d.nama_korban_jiwa + ` </h6>
							<span class=""> NIK : ` + d.nik_korban_jiwa + ` </span> 
							<span class=""> TTL : ` + d.tmpt_lahir + ` , ` + d.tgl_lahir +`</span> 
						</div>
					</div>`;
							return profil;
						}
					...
					<table style="padding: 0px;" cellspacing="0" cellpadding="0" >
						<tr style="background-color: rgba(255,255,255,0.9)!important;"> 
							<td style="width: auto; padding: 0px; border: 0px;">` + d.alamat_korban_jiwa +` </td> 
						</tr>
					</table>`;
							return alamat;
						}
		...
		// 		//ajax			: base_url+'admin/korban_bencana/get_data', 
		// 		ajax: {
		// 			url: base_url + 'admin/korban_bencana/assesment_bencana',
		// 			type: "POST",
		// 			dataType: 'JSON',
		// 			data: {
		// 				id_kategori: id_kategori
	...
	function assesment_bencana() {
		$.ajax({
			url: base_url + 'admin/korban_bencana/kategori_bencanas',
			type: 'POST',
			success: function(data) {
				console.log(data)
			}
