...
$(document).ready(function() {
    ...
    $('#btn_map_search').click(function(e) {
        if ($('#side_layers.large_screen input[type="checkbox"]:checked').length > 0) {
            ...
            $('#layer_search').html(
                '<option value="all_layer" selected>-- Tampilkan Semua Layer --</option>');
            $('#feature_search').attr('placeholder', 'Cari semua...');
        } else {
            // $('#kecamatan_search').val('').trigger('change');
            $('#layer_search').html(
                '<option value="all_layer" selected>-- Tidak Ada Layer Aktif --</option>');
        ...
        $('#side_layers.large_screen input[type="checkbox"]:checked').each(function(i) {
            $('#layer_search').append('<option value="' + $(this).attr('name') + '">' + $(this)
                .attr('data-name') + '</option>');
            let nl =
                '<div style="font-size:larger;font-weight:bolder; margin-top: 20px; margin-bottom:10px">' +
                $(this).attr('data-name') + '</div>';
            $('#feature_name').append(nl);
            layers[$(this).attr('name')].eachLayer(l => {
                let fn = '';
                fn += '<div class="feature_name" data-name="' + $(this).attr('name') +
                    '" data-id="' + l._leaflet_id + '">';
    ...
    $('#layer_search').change(function(e) {
        ...
        if ($(this).val() == 'all_layer') {
            ...
            $('#side_layers.large_screen input[type="checkbox"]:checked').each(function(i) {
                ...
                layers[$(this).attr('name')].eachLayer(l => {
                    let fn = '';
                    fn += '<div class="feature_name" data-name="' + $(this).attr(
                        'name') + '" data-id="' + l._leaflet_id + '">';
                    fn += '<i class="si si-pointer"></i> ';
                    fn += l.feature.properties.name;
                    fn += '</div>';
                    $('#feature_name').append(fn)
            ...
            $('#feature_search').attr('placeholder', 'Cari ' + $('#layer_search option[value="' + $(
                this).val() + '"]')[0].text + '...');
            let nl =
                '<div style="font-size:larger;font-weight:bolder; margin-top: 20px; margin-bottom:10px">' +
                $('#layer_search option[value="' + $(this).val() + '"]')[0].text + '</div>';
            $('#feature_name').append(nl);
            layers[$(this).val()].eachLayer(l => {
                let fn = '';
                fn += '<div class="feature_name" data-name="' + $(this).val() + '" data-id="' +
                    l._leaflet_id + '">';
                fn += '<i class="si si-pointer"></i> ';
                fn += l.feature.properties.name;
                fn += '</div>';
    ...
    function generate_search() {
        ...
        if ($('#layer_search').val() == 'all_layer') {
            $('#side_layers.large_screen input[type="checkbox"]:checked').each(function(i) {
                ...
                layers[$(this).attr('name')].eachLayer(l => {
                    ...
                    if (
                        ...
                        typeof l.feature.properties.name !== 'undefined' &&
                        typeof l.feature.properties.Kecamatan !== 'undefined' &&
                        (typeof l.feature.properties.Kelurahan == 'undefined' || l.feature
                            .properties.Kelurahan == '' || l.feature.properties.Kelurahan ==
                            null) &&
                        l.feature.properties.name !== null &&
                        l.feature.properties.Kecamatan !== null &&
                        ...
                        typeof l.feature.properties.name !== 'undefined' &&
                        typeof l.feature.properties.Kelurahan !== 'undefined' &&
                        (typeof l.feature.properties.Kecamatan == 'undefined' || l.feature
                            .properties.Kecamatan == '' || l.feature.properties.Kecamatan ==
                            null) &&
                        l.feature.properties.name !== null &&
                        l.feature.properties.Kelurahan !== null &&
            ...
            let nl = '<div style="font-size:larger;font-weight:bolder; margin-top: 20px; margin-bottom:10px">' +
                $('#layer_search option[value="' + $('#layer_search').val() + '"]')[0].text + '</div>';
            $('#feature_name').append(nl);
            layers[$('#layer_search').val()].eachLayer(l => {
                ...
                if (
                    ...
                    typeof l.feature.properties.name !== 'undefined' &&
                    typeof l.feature.properties.Kecamatan !== 'undefined' &&
                    (typeof l.feature.properties.Kelurahan == 'undefined' || l.feature.properties
                        .Kelurahan == '' || l.feature.properties.Kelurahan == null) &&
                    l.feature.properties.name !== null &&
                    l.feature.properties.Kecamatan !== null &&
                    $('#kelurahan_search').val() == ''
                ) {
                    ...
                    typeof l.feature.properties.name !== 'undefined' &&
                    typeof l.feature.properties.Kelurahan !== 'undefined' &&
                    (typeof l.feature.properties.Kecamatan == 'undefined' || l.feature.properties
                        .Kecamatan == '' || l.feature.properties.Kecamatan == null) &&
                    l.feature.properties.name !== null &&
                    l.feature.properties.Kelurahan !== null &&
                    $('#kecamatan_search').val() == ''
                ) {
    ...
    $('#mobile_tabs a[href="#mobile_search"]').click(function(e) {
        ...
        $('#mobile_layers #side_layers input[type="checkbox"]:checked').each(function(i) {
            ...
            $('#m_layer_search').append('<option value="' + $(this).attr('name') + '">' + $(
                this).attr('data-name') + '</option>');
            let nl =
                '<div style="font-size:larger;font-weight:bolder; margin-top: 20px; margin-bottom:10px">' +
                $(this).attr('data-name') + '</div>';
    ...
    $('#m_layer_search').change(function(e) {
        ...
        if ($(this).val() == 'all_layer') {
            ...
            $('#m_feature_search').attr('placeholder', 'Cari ' + $('#m_layer_search option[value="' + $(
                this).val() + '"]')[0].text + '...');
            let nl =
                '<div style="font-size:larger;font-weight:bolder; margin-top: 20px; margin-bottom:10px">' +
                $('#m_layer_search option[value="' + $(this).val() + '"]')[0].text + '</div>';
            $('#m_feature_name').append(nl);
            layers[$(this).val()].eachLayer(l => {
                let fn = '';
                fn += '<div class="feature_name" data-name="' + $(this).val() + '" data-id="' +
    ...
    $('#m_feature_search').keyup(function() {
        ...
        if ($('#m_layer_search').val() == 'all_layer') {
                ...
                layers[$(this).attr('name')].eachLayer(l => {
                    ...
                    if (l.feature.properties.name !== null) {
                        if (l.feature.properties.name.match(cari)) {
                            let fn = '';
                            fn += '<div class="feature_name" data-name="' + $(this)
                                .attr('name') + '" data-id="' + l._leaflet_id + '">';
                            fn += '<i class="si si-pointer"></i> ';
                            fn += l.feature.properties.name;
                            fn += '</div>';
                            $('#m_feature_name').append(fn);
            ...
            let nl =
                '<div style="font-size:larger;font-weight:bolder; margin-top: 20px; margin-bottom:10px">' +
                $('#m_layer_search option[value="' + $('#m_layer_search').val() + '"]')[0].text +
                '</div>';
            $('#m_feature_name').append(nl);
            layers[$('#m_layer_search').val()].eachLayer(l => {
                ...
                if (l.feature.properties.name !== null) {
                    if (l.feature.properties.name.match(cari)) {
                        let fn = '';
                        fn += '<div class="feature_name" data-name="' + $('#m_layer_search')
                            .val() + '" data-id="' + l._leaflet_id + '">';
                        fn += '<i class="si si-pointer"></i> ';
                        fn += l.feature.properties.name;
                        fn += '</div>';
                        $('#m_feature_name').append(fn);
...
function get_map(cb, geojson_url) {
    ...
    function osm_style(f) {
        ...
        var stroke_opacity = (typeof f.properties['stroke_opacity'] != 'undefined') ? f.properties['stroke_opacity'] :
            0.7;
    ...
    function osm_info(e) {
        ...
        if (cb.hasClass('default_layers')) {
            ...
            Object.keys(o).map((v, i, a) => {
                if (!['id_layer', 'id_opd', 'id_collection', 'stroke', 'stroke_opacity', 'stroke_width', 'fill',
                        'fill_opacity', 'icon_name', 'page_detail', 'name', 'group'
                    ].includes(v)) {
                    // if(v == 'nama_layer')
                    // {
                    ...
                    if (v == 'nama_layer') {
                        content +=
                            '<tr><td colspan="3" style="font-size:larger; font-weight:bold;margin-bottom:5px;">';
                        content += '<div>' + o[v] + '</div>';
                        if (o.page_detail == 1) {

                            content += '<div style="margin: 1px; text-align:left;">';
                            content += '<a href="<?= base_url() ?>peta/informasi-detail/' + o.id_collection +
                                '" class="btn btn-sm btn-rounded btn-outline-danger" target="_blank" title="Informasi Selengkapnya"><i class="si si-action-redo"></i></a>';

                        }
                        if (xdata[cb.attr('name')].length > 0) {
                            content +=
                                '<button class="btn btn-sm btn-rounded btn-outline-info btn_infografis" title="Infografis" style="margin-left: 5px;"><i class="si si-grid"></i></button>';
                            content += '</div>';
                        }
        ...
        async function generate_infografis(d) {
            ...
            Promise.all(generate_canvas)
                .then((res) => {
                    res.map(v => {
                        ...
                        if (x.tipe_grup.substring(x.tipe_grup.length - 5, x.tipe_grup.length) ==
                            'chart') {
            ...
            function get_chart_labels(d, i) {
                ...
                let x = [];
                a.map(v => {
                    let n = b[v]['alias_atribut_layer'] != null ? b[v]['alias_atribut_layer'].trim() != '' ?
                        b[v]['alias_atribut_layer'] : b[v]['nama_atribut_layer'] : b[v][
                            'nama_atribut_layer'
                        ];
                    x.push(n);
                })
            ...
            function get_chart_dataset_multi(d, i) {
                ...
                a.map(v => {
                    let n = {}
                    n['label'] = b[v]['alias_atribut_layer'] != null || b[v]['alias_atribut_layer']
                        .trim() == '' ? b[v]['alias_atribut_layer'] : b[v]['nama_atribut_layer'];
            ...
            function generate_data_table(cn, fp, i) {
                ...
                sort.map(v => {
                    x += '<tr>';
                    x += '<td>' + (xalias[cn][v]['alias_atribut_layer'] != null ? (xalias[cn][v][
                        'alias_atribut_layer'
                    ].trim() != '' ? xalias[cn][v]['alias_atribut_layer'] : xalias[cn][v][
                        'nama_atribut_layer'
                    ]) : xalias[cn][v]['nama_atribut_layer']) + '</td>';
        ...
        if (data.features.length > 0) {
            ...
            layers[cb.attr('name')] = new L.geoJSON(data, {
                ...
                pointToLayer: function(f, latlng) {
                    ...
                    var icon_name = f.properties.icon_name != null && f.properties.icon_name != '' ?
                        f.properties.icon_name : 'default';
                    var icon = L.icon({
                        iconUrl: '<?= base_url() ?>assets/uploads/marker_icon/' +
                            icon_name + '.png',
                        iconSize: ['auto', 30],
                        popupAnchor: [0, -15]
                    })
...
var mymap = L.map('map', {
    zoomControl: false
}).setView([-7.5519941, 110.8003075], 17);
L.tileLayer(
    ...
    success: function(data) {
        ...
        data.forEach(element => {
            ...
            $.each(element.result, function(index, value) {
                const ijo = (() => {
                    if (value.status == 'Responded') {
                        return '<br><b>Status :</b><span data-toggle="modal" data-target="#exampleModal" id="click" data-id="' +
                            value.content + '" class="text-success col-6 click">' +
                            value.status + '</span>';
                    } else if (value.status == 'Process') {
                        return '<br><b>Status :</b><span data-toggle="modal" data-target="#exampleModal" id="click" data-id="' +
                            value.content + '"class="text-warning col-6 click">' +
                            value.status + '</span>';
                    } else {
                        return '<br><b>Status :</b><span data-toggle="modal" data-target="#exampleModal" id="click" data-id="' +
                            value.content + '" class="text-warning col-6 click">' +
                ...
                const marker = L.marker([value.lat, value.long]).bindPopup('Judul : ' +
                    value.title + ijo + '<br><b>Unit : </b>' + value.unit_del +
                    '<br><b>Kategori : </b>' + value.cat + '<br><b>Tanggal : </b>' +
                    value.tgl_sug + '<br><b>Nama : </b>' + value.name +
                    '<br><b>Email : </b>' + value.mail + '<br><b>Telepon : </b>' + value
                    .telp +
                    ...
                    value + '" class="text-info col-6 click">Selengkapnya</a>').addTo(
                    mymap);
            });
        });
    },
