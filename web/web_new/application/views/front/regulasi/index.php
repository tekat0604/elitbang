    ...
    <section class="section-padding">
        <div class="container">
            <div class="text-center mb-50">
                <h2 class="section-title">Regulasi INTIP Kota Surakarta</h2>
            ...
            <div class="row">
                <table id="table_regulasi" class="table table-striped">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center"><a href="<?=base_url()?>assets/regulasi/<?=$v['file']?>" target="_blank" class="btn btn-primary" style="height:30px; font-size: x-small; padding-top: 2px; background:#ff0000"><i class="fa fa-download"></i> Unduh File</a></td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
                </table>
