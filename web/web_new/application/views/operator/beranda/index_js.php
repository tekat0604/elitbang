...
function garfik_laporan_aduan(){
    $.ajax({
        type        : 'ajax', 
        url         : '<?= base_url() ?>operator/beranda/api',
        async       : false,
        dataType    : 'json',
        success     : function(response){
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: $kategori,
                    datasets: [{
                        label: '# Jumlah Kerusakan Fasilitas',
                        data: $total_laporan,
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [response.data_statistik[0].pengunjunghariini, response.data_statistik[0].pengunjungonline, response.data_statistik[0].totalpengunjung],
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
                            'rgba(255, 206, 86, 0.2)',
