        ...
        <div class="container">
            <div class="row justify-content-center align-items-center small-screen">
                <div class="col-12 col-xl-6 col-lg-7 col-md-10 position-relative page-title-large text-center">
                    ...
                    <h1 class="text-white alt-font font-weight-500 letter-spacing-minus-1 margin-10px-bottom">Berita</h1>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <li class="grid-item wow animate__fadeIn mt-2">
                                <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                    <div class="blog-post-image bg-medium-slate-blue">
                                        <a href="<?= base_url('berita/detail/' . $row->tanggal . '/' . $row->id) ?>" title="" ><img src="<?= $img?>" alt="" id="container1"></a>
                                        <!-- <a href="blog-single.html" class="blog-category alt-font">Creative</a> -->
                                    </div>
                                    <!-- </div> -->
                                    <div class="post-details padding-3-rem-lr padding-2-half-rem-tb">
                                        ...
                                        <a href="<?= base_url('berita/detail/' . $row->tanggal . '/' . $row->id) ?>" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray margin-15px-bottom d-block"><?= $row->judul ?> - <?= date('Y', strtotime($row->tanggal)) ?></a>
