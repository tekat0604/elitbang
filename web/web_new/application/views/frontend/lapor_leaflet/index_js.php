            ...
            `);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "captcha_salah") {
                            $('#error_captcha').html(`
                            <div class="text-danger"> 
                             <i class="fa fa-exclamation-triangle"></i> Kode captcha salah , 
                             Silahkan isi kode dengan benar 
                            </div>
                        `);
                        } else if (data == "ok") {
                            $('#notifikasi_aduan').html(`
                            <div class="alert alert-success" role="alert">
                                <i class="fa fa-check-circle"></i> Laporan Anda telah dikirim.
                            </div> 
                        `);
