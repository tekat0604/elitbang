        ...
        <div class="navbar yamm navbar-default">
            ...
            <div id="navbar-collapse-1" class="navbar-collapse collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown <?= @$li_berita ?>"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Berita </a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="<?= @$li_berita ?>"><a href="<?php echo base_url('berita'); ?>">Semua</a></li>
                    ...
                    <li class="<?= @$li_lapor ?>"><a href="<?= base_url('lapor') ?>"> Pengaduan</a></li>
