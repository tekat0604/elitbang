...
function daftar_rpr(){
    ...
    $.ajax({
        type  : 'ajax',
        url   : '<?php echo base_url()?>opd/referensi/daftar_rpr',
        async : false,
        dataType : 'json',
...
$('#form_rpr').submit(function(e){
    e.preventDefault();
    $.ajax({
        url:'<?php echo base_url();?>opd/referensi/form_rpr',
        type:"post",
...
$('#show_data').on('click','.item_edit',function(){
    ...
    $.ajax({
        type : "GET",
        url  : "<?php echo base_url('opd/referensi/get_rpr')?>",
        dataType : "JSON",
        data : {id:id},
        success: function(data){
...
function hapus(id){
    $.ajax({
    type : "POST",
    url  : "<?php echo base_url('opd/referensi/hapus_rpr')?>",
    dataType : "JSON",
