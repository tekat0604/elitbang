    ...
    <div class="content">
        ...
        <div class="block block-themed">
            <div class="block-header bg-gd-sun">
                <h3 class="block-title">Referensi Status Tanah</h3>
                <button type="button" class="btn btn-secondary btn-square" style="margin-bottom:10px;" data-toggle="modal" data-target="#modal-st"><i class="fa fa-plus"></i> Tambah Status Tanah</button>
            </div>
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">Tambah Status Tanah</h3>
                ...
                <div class="block-content">
                    ...
                    <div class="form-group row">
                        <label class="col-12" for="nama_st">Nama Status Tanah</label>
                        <div class="col-md-12">
