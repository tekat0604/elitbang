        ...
        <div class="row gutters-tiny invisible" data-toggle="appear">
            ...
            <div class="col-6 col-xl-3">
                <a class="block block-link-shadow text-right" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix">
                        <div class="float-left mt-10 d-none d-sm-block">
                            <i class="fa fa-map-marker fa-3x text-body-bg-dark"></i>
                        </div>
                        <div class="font-size-h3 font-w600"><span data-toggle="countTo" data-speed="1000" data-to="<?=$chart['ikon']?>">0</span></div>
                        <div class="font-size-sm font-w600 text-uppercase text-muted">Ikon</div>
                    </div>
                </a>
            </div>
            <div class="col-6 col-xl-3">
