...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#form_grup').submit(function(e) {
            ...
            if (mode == 'tambah') {
                ...
                $.ajax({
                        url: '<?= base_url() ?>opd/peta/add_group',
                        type: "POST",
                        dataType: "JSON",
                        data: data,
                        contentType: false,
                    ...
                    .then(res => {
                        ...
                        if (res.status == 'success') {
                            ...
                            $.ajax({
                                    url: '<?= base_url() ?>opd/peta/update_pos_group',
                                    type: 'POST',
                                    dataType: 'JSON',
                                    data: {
                                        id_layer: id_layer,
                ...
                $.ajax({
                        url: '<?= base_url() ?>opd/peta/edit_group',
                        type: "POST",
                        dataType: "JSON",
                        data: data,
                        contentType: false,
    ...
    function isian() {
        ...
        $.ajax({
            type: "GET",
            url: '<?= base_url() ?>opd/peta/get_layer_data',
            dataType: "JSON",
            data: {
                id: id
            },
    ...
    function init_group() {
        ...
        $.ajax({
                url: '<?= base_url() ?>opd/peta/get_group',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    id_layer: id
            ...
            .then(res => {
                ...
                $('.group_title_item').contextmenu(async function(e) {
                    ...
                    if (z) {
                        ...
                        $('.edit_group_title').click(function(e) {
                            ...
                            $('#modal_grup').modal('show');
                            $.ajax({
                                    url: '<?= base_url() ?>opd/peta/get_group_detail',
                                    type: 'POST',
                                    dataType: 'JSON',
                                    data: {
                                        id: id_group
                        ...
                        $('.delete_group_title').click(function(e) {
                            ...
                            Swal.fire({
                                ...
                                if (result.value) {
                                    $.ajax({
                                            url: '<?= base_url() ?>opd/peta/delete_group',
                                            type: 'POST',
                                            dataType: 'JSON',
                                            data: {
                ...
                $('.group_title_item').click(function(e) {
                    ...
                    $('#loader_box').show();
                    $.ajax({
                            url: '<?= base_url() ?>opd/peta/get_group_items',
                            type: 'POST',
                            dataType: 'JSON',
                            data: {
                                id: id
                        ...
                        .then(res => {
                            ...
                            $('#group_attribute, #layer_attribute').sortable({
                                ...
                                update: function(e, i) {
                                    ...
                                    $.ajax({
                                        url: '<?= base_url() ?>opd/peta/update_pos_group_item',
                                        type: 'POST',
                                        dataType: 'JSON',
                                        data: {
                                            id_group: id,
                            ...
                            $('.draggable_item').draggable({
                                ...
                                stop: function(x) {
                                    ...
                                    if (parent == 'group_attribute' && parent != parent_old) {
                                        ...
                                        $('#loader_box').show();
                                        $.ajax({
                                                url: '<?= base_url() ?>opd/peta/add_group_item',
                                                type: 'POST',
                                                dataType: 'JSON',
                                                data: {
                                        ...
                                        $('#loader_box').show();
                                        $.ajax({
                                                url: '<?= base_url() ?>opd/peta/delete_group_item',
                                                type: 'POST',
                                                dataType: 'JSON',
                                                data: {
                                ...
                                $('#group_attribute .group_item').contextmenu(async function(e) {
                                    ...
                                    if (z) {
                                        ...
                                        $('#form_rename').unbind().submit(function(f) {
                                            ...
                                            if (alias != '') {
                                                $.ajax({
                                                        url: '<?= base_url() ?>opd/peta/rename_group_item',
                                                        type: 'POST',
                                                        dataType: 'JSON',
                                                        data: {
                                                            id_item: id_item,
