                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php if($atribut->tipe_data != "File"){ ?>
                                        <input required type="text" class="form-control <?php if($atribut->tipe_data == "Angka"){echo "angka-saja";} ?>" id="<?= $atribut->slug; ?>" name="<?= $atribut->slug; ?>" placeholder="Masukkan <?= $atribut->nama_atribut; ?>" value="<?=$data_collection[$atribut->slug]?>">
                                    <?php }else{ ?>
