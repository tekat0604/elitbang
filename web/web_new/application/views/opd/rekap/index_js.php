...
<script type="text/javascript">
	...
	function tampil_data_rtr(){
        ...
        table = $('#mydata').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('opd/rekap/get_data_rtr/');?>",
                "type": "POST"
            },
    ...
    $(document).on('click','.modal-detail-rtr',function(e){
        ...
        $.post('<?php echo base_url('opd/rekap/detail_rtr')?>',
            {
    ...
    $(document).on('click','.modal-detail-kkr',function(e){
        ...
        $.post('<?php echo base_url('opd/rekap/detail_kkr')?>',
            {
                id:$(this).attr('data-id')
            },
            function(html){
    ...
    function tampil_data_kkr(){
        ...
        table = $('#mydata').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('opd/rekap/get_data_kkr/');?>",
                "type": "POST"
            },
