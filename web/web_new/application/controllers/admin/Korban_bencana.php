...
class Korban_bencana extends MY_Controller
{
    ...
    public function Korban()
    {
        $data = [
            'isi'       => "$this->base/index",
            'modal'     => array(
                $this->load->view("admin/modal_detail", '', true),
                $this->load->view("$this->base/modal_hapus", '', true)
            ),
            'extra_css'  => $this->load->view("$this->base/index_css", '', true),
            'extra_js'  => $this->load->view("$this->base/index_js", '', true),
        ];
    ...
    public function get_data()
    {
        ...
        // }
        $this->db->select('tabel_korban_jiwa.nik as nik_korban_jiwa,
            tabel_korban_jiwa.nama as nama_korban_jiwa,
            tabel_korban_jiwa.alamat as alamat_korban_jiwa,
            tabel_korban_jiwa.tgl_lahir,
            tabel_korban_jiwa.tmpt_lahir,
            ...
            if ($id_kategori != '') {
                $this->db->where('tabel_korban_jiwa.id_kategori', $id_kategori);
            }
