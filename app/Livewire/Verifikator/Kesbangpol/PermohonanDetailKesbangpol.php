...
class PermohonanDetailKesbangpol extends Component
{
    ...
    protected function messages()
    {
        return [
            ...
            'catatan_kesbangpol.required_if' => 'Catatan wajib diisi jika Anda meminta revisi atau menolak permohonan.',
        ];
    }

    public function simpanVerifikasi()
    {
        // Wajib isi catatan jika Revisi ATAU Ditolak
        $this->validate([
            'status_kesbangpol' => 'required|in:pending,revisi,disetujui,ditolak',
            'catatan_kesbangpol' => 'required_if:status_kesbangpol,revisi,ditolak|nullable|string'
        ]);
