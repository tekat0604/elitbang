...
@section('content')
  <div class="container-fluid p-0 dashboard-shell">
    <div class="row g-0 h-100">
      <!-- Sidebar -->
      <div class="col-12 col-md-3 dashboard-sidebar">
        <aside class="sidebar-dash">
          ...
          <nav class="nav flex-column">
            ...
            <a class="nav-link py-2 mb-1" href="{{ route('identitas') }}"> Data Diri
            </a>
            <a class="nav-link py-2 mb-1" href="{{ route('permohonan') }}"> Permohonan
            </a>
          </nav>
        </aside>
      </div>
      ...
      <!-- Main content -->
      <main class="col-12 col-md-9 p-4 dashboard-main">
        <div class="row g-4">
          <div class="col-12">
          ...
          <!-- Tahapan Pengajuan Permohonan Izin (main content) -->
          <div class="col-12">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <div class="border rounded-3 p-3 h-100">
                    ...
                    <p class="mb-0 text-body-secondary">
                      Setelah berhasil mendaftar dan bisa login akun. pemohon wajib mengisi data diri sebelum bisa
                ...
                <div class="col-md-6">
                  <div class="border rounded-3 p-3 h-100">
                    ...
                    <p class="mb-0 text-body-secondary">
                      Verfikasi data diri pemohon oleh admin dari BRIDA. Pemohon akan menerima notifikasi jika data diri
                      telah diverifikasi.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="border rounded-3 p-3 h-100">
                    ...
                    <p class="mb-0 text-body-secondary">
                      Setelah data diri Pemohon terverifikasi, Pemohon dapat mengajukan permohonan dan bisa memilih
                      katergori yang akan diajukan.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="border rounded-3 p-3 h-100">
                    ...
                    <p class="mb-0 text-body-secondary">
                      Data pengajuan permohonan akan dilakukan verifikasi oleh 2 Perangkat Daerah ,yaitu Kesbangpol &
                      BRIDA.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="border rounded-3 p-3 h-100">
                    ...
                    <p class="mb-0 text-body-secondary">
                      Setelah verifikasi distujui oleh 2 Perangkat daerah, data permohonan akan di generate menjadi
                      dokumen pdf yang nanti bisa ditandatangi menggunakan TTE dari 2 Perangkat Daerah.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="border rounded-3 p-3 h-100">
                    ...
                    <p class="mb-0 text-body-secondary">
                      Pemohon bisa mengunduh Dokumen persetujuan dan surat selesai penelitian yang telah di tandatangani
                      oleh 2 Perangkat Daerah.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="border rounded-3 p-3 h-100">
                    ...
                    <p class="mb-0 text-body-secondary">
                      Setelah Pemohon melaksanakan kegiatan penelitian, Pemohon wajib mengunggah laporan penelitian ke
                      sistem BRIDA Kota Surakarta.
                    </p>
                  </div>
                </div>
