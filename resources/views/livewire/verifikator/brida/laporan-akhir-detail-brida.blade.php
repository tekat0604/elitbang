                ...
                <div class="card-body p-4">
                    ...
                    @else
                        <form wire:submit="simpanVerifikasi">
                            <div class="mb-4"><label class="form-label fw-semibold">Keputusan</label><select wire:model.live="statusLaporan" class="form-select @error('statusLaporan') is-invalid @enderror"><option value="pending">Menunggu</option><option value="disetujui">Terima Laporan</option><option value="revisi">Revisi</option></select>@error('statusLaporan') <div class="invalid-feedback">{{ $message }}</div> @enderror</div>
