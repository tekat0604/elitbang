                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="fw-semibold fs-6">{{ $pemohon->no_hp }} <br> <span class="text-primary">{{ $pemohon->email }}</span></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <span class="text-muted small">TTL & Kewarganegaraan</span>
                            <div class="fw-semibold fs-6">{{ \Carbon\Carbon::parse($pemohon->tanggal_lahir)->format('d M Y') }} ({{ $pemohon->kewarganegaraan }})</div>
                        </div>
                    ...
                    <div class="border rounded p-2 text-center bg-light">
                        <img src="{{ asset('storage/' . $pemohon->path_identitas) }}" class="img-fluid rounded shadow-sm" alt="Foto Identitas" style="max-height: 400px; object-fit: contain;">
                    </div>
                </div>
            </div>
        </div>
