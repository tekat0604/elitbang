            ...
            <div class="col-lg-10 mx-auto row container align-items-center justify-content-center">
                <div class="col-lg-5">
                    <div class="hero-text-box position-relative px-lg-5 mb-12 mb-lg-0">
                        <h1 class="text-primary display-6 fw-extrabold" style="line-height: 2.5rem">{{ config('title_nav')}}</h1>
                        <h2 class="hero-sub-title h6 mb-6">
                            {{ config('deskripsi') }}
                        </h2>
                        <div class="d-flex align-items-center gap-3">
                          <div class="landing-hero-btn d-inline-block position-relative">
                              <a href="#" data-bs-toggle="modal" data-bs-target="#alurPerizinan" class="btn btn-secondary btn-lg">Alur Perizinan</a>
                          </div>
                          <div class="landing-hero-btn d-inline-block position-relative">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#exLargeModal">
                          <div class="card h-100 layanan-box">
                            <div class="card-body text-center">
                              <div class="bg-primary rounded-pill d-inline-block p-3 text-white" style="height: 75px; width: 75px;">
                                 <img src="{{ asset('storage/layanan/' . $item->logo) }}" alt="logo" class="h-100" data-speed="1" />
                              </div>
